...
<head>
    ...
    <style>
        ...
        @keyframes lightningPulse {
            0% { transform: scale(1) rotate(0deg); filter: drop-shadow(0 0 0px rgba(250, 204, 21, 0)); }
            30% { transform: scale(1.2) rotate(-10deg); filter: drop-shadow(0 0 15px rgba(250, 204, 21, 0.8)); }
            60% { transform: scale(1.1) rotate(10deg); filter: drop-shadow(0 0 10px rgba(250, 204, 21, 0.6)); }
            100% { transform: scale(1) rotate(0deg); filter: drop-shadow(0 0 0px rgba(250, 204, 21, 0)); }
        }
...
<body class="bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 min-h-screen text-slate-900 overflow-x-hidden selection:bg-indigo-200">
    ...
    <script type="text/babel">
        ...
        const TIME_NOW = ["now", "at the moment", "right now"];
        ...
        const VERBS_IRREGULAR = [
            { base: "be", past: "was/were", pp: "been" }, { base: "beat", past: "beat", pp: "beaten" }, { base: "become", past: "became", pp: "become" }, { base: "begin", past: "began", pp: "begun" },
            { base: "bite", past: "bit", pp: "bitten" }, { base: "break", past: "broke", pp: "broken" }, { base: "bring", past: "brought", pp: "brought" }, { base: "build", past: "built", pp: "built" },
            { base: "buy", past: "bought", pp: "bought" }, { base: "catch", past: "caught", pp: "caught" }, { base: "choose", past: "chose", pp: "chosen" }, { base: "come", past: "came", pp: "come" },
            { base: "cost", past: "cost", pp: "cost" }, { base: "cut", past: "cut", pp: "cut" }, { base: "do", past: "did", pp: "done" }, { base: "draw", past: "drew", pp: "drawn" },
            { base: "drink", past: "drank", pp: "drunk" }, { base: "drive", past: "drove", pp: "driven" }, { base: "eat", past: "ate", pp: "eaten" }, { base: "fall", past: "fell", pp: "fallen" },
            { base: "feel", past: "felt", pp: "felt" }, { base: "fight", past: "fought", pp: "fought" }, { base: "find", past: "found", pp: "found" }, { base: "fly", past: "flew", pp: "flown" },
            { base: "forget", past: "forgot", pp: "forgotten" }, { base: "forgive", past: "forgave", pp: "forgiven" }, { base: "freeze", past: "froze", pp: "frozen" }, { base: "get", past: "got", pp: "got" },
            { base: "give", past: "gave", pp: "given" }, { base: "go", past: "went", pp: "gone" }, { base: "grow", past: "grew", pp: "grown" }, { base: "have", past: "had", pp: "had" },
            { base: "hear", past: "heard", pp: "heard" }, { base: "hide", past: "hid", pp: "hidden" }, { base: "hit", past: "hit", pp: "hit" }, { base: "hold", past: "held", pp: "held" },
            { base: "hurt", past: "hurt", pp: "hurt" }, { base: "keep", past: "kept", pp: "kept" }, { base: "know", past: "knew", pp: "known" }, { base: "leave", past: "left", pp: "left" },
            { base: "lend", past: "lent", pp: "lent" }, { base: "let", past: "let", pp: "let" }, { base: "lose", past: "lost", pp: "lost" }, { base: "make", past: "made", pp: "made" },
            { base: "meet", past: "met", pp: "met" }, { base: "pay", past: "paid", pp: "paid" }, { base: "put", past: "put", pp: "put" }, { base: "read", past: "read", pp: "read" },
            { base: "ride", past: "rode", pp: "ridden" }, { base: "ring", past: "rang", pp: "rung" }, { base: "run", past: "ran", pp: "run" }, { base: "say", past: "said", pp: "said" },
            { base: "see", past: "saw", pp: "seen" }, { base: "sell", past: "sold", pp: "sold" }, { base: "send", past: "sent", pp: "sent" }, { base: "sing", past: "sang", pp: "sung" },
            { base: "sit", past: "sat", pp: "sat" }, { base: "sleep", past: "slept", pp: "slept" }, { base: "speak", past: "spoke", pp: "spoken" }, { base: "spend", past: "spent", pp: "spent" },
            { base: "stand", past: "stood", pp: "stood" }, { base: "steal", past: "stole", pp: "stolen" }, { base: "swim", past: "swam", pp: "swum" }, { base: "take", past: "took", pp: "taken" },
            { base: "teach", past: "taught", pp: "taught" }, { base: "tear", past: "tore", pp: "torn" }, { base: "tell", past: "told", pp: "told" }, { base: "think", past: "thought", pp: "thought" },
            { base: "throw", past: "threw", pp: "thrown" }, { base: "understand", past: "understood", pp: "understood" }, { base: "wake", past: "woke", pp: "woken" }, { base: "wear", past: "wore", pp: "worn" }, { base: "weep", past: "wept", pp: "wept" },
            { base: "win", past: "won", pp: "won" }, { base: "write", past: "wrote", pp: "written" }
        ];
        ...
        // --- 2. HELPER FUNCTIONS ---
        const getRuleForTopic = (topicName) => {
            const t = topicName.toLowerCase();
            if (t.includes("irregular") || t.includes("past simple")) return "Use the Past Simple for finished actions. \n• Regular verbs: add '-ed'.\n• Irregular verbs: memorize the special form (e.g., go -> went).";
            if (t.includes("present simple")) return "Use Present Simple for facts, habits, and routines.\n• I/You/We/They work.\n• He/She/It works (add 's').";
            if (t.includes("present continuous")) return "Use Present Continuous for actions happening now.\n• Subject + am/is/are + verb-ing.";
            if (t.includes("present perfect")) return "Use Present Perfect for experiences or recent actions with a connection to now.\n• Have/Has + Past Participle.";
            if (t.includes("past perfect")) return "Use Past Perfect (Had + PP) for an action that happened before another past action.";
            if (t.includes("future")) return "• Will: Predictions or instant decisions.\n• Going to: Plans or evidence.\n• Present Continuous: Fixed arrangements.";
            if (t.includes("conditional")) return "• Zero: Facts (If + Present, Present)\n• First: Real possibility (If + Present, Will)\n• Second: Hypothetical (If + Past, Would)\n• Third: Regrets (If + Past Perf, Would have)";
            if (t.includes("reported")) return "When reporting speech, usually move the tense one step back into the past.";
            if (t.includes("passive")) return "Focus on the object. Structure: Be + Past Participle.\n(e.g., 'The cake was eaten').";
            if (t.includes("modal")) return "Modals (can, must, should, might) add meaning like ability, obligation, or possibility. They are followed by the base verb.";
            if (t.includes("relative") || t.includes("clauses")) return "Use relative pronouns (who, which, that, where) to give more information about a noun.";
            if (t.includes("inversion")) return "In formal English, invert the subject and auxiliary verb after negative adverbials (e.g., 'Never have I seen...').";
            if (t.includes("gerund") || t.includes("infinitive")) return "Some verbs are followed by -ing (enjoy swimming), others by to-infinitive (want to swim).";
            if (t.includes("preposition") || t.includes("article") || t.includes("linking")) return "• At: specific times/places.\n• On: days/surfaces.\n• In: months/years/enclosed spaces.\n• Articles: 'A/An' for non-specific, 'The' for specific.";
            return "Review the grammar structure carefully. Focus on accuracy and context.";
        };
        ...
        const generateGrammarExercises = (topicName, count = 10) => {
            ...
            // Helper to get Unique verbs
            const getUniqueVerbs = (list, num) => [...list].sort(() => 0.5 - Math.random()).slice(0, num);
            // Helper to clean verbs ending in e for ing
            const toIng = (v) => {
            ...
            if (t.includes("past") || t.includes("irregular") || t.includes("did")) {
                ...
                verbs.forEach((v, i) => {
                    const s = randSubj();
                    let q = {};
                    if (t.includes("participle") || t.includes("perfect")) {
                         q = { text: `${s} has ___ (${v.base}) ${randObj()}.`, answer: v.pp };
                    } else if (t.includes("negative")) {
                         q = { text: `${s} ___ (not / ${v.base}) ${randObj()} ${randTimePast()}.`, answer: `did not ${v.base}` };
                    } else if (t.includes("question")) {
                         q = { text: `___ (${s} / ${v.base}) ${randObj()}?`, answer: `Did ${s.toLowerCase()} ${v.base}` };
                    } else {
                         q = { text: `${randTimePast()}, ${s} ___ (${v.base}) ${randObj()}.`, answer: v.past };
                    }
            ...
            // 2. PRESENT SIMPLE
                ...
                verbs.forEach((v, i) => {
                    ...
                    if (t.includes("negative")) {
                         const aux = is3rd ? "does not" : "do not";
                         q = { text: `${s} ___ (not / ${v.base}) ${randObj()}.`, answer: `${aux} ${v.base}` };
                    } else if (t.includes("question")) {
                         const aux = is3rd ? "Does" : "Do";
                         q = { text: `___ (${s} / ${v.base}) ${randObj()}?`, answer: `${aux} ${s.toLowerCase()} ${v.base}` };
                    } else {
                         let ans = v.base;
                         if(is3rd) {
                             if(v.base === 'have') ans = 'has';
                             else if(v.base === 'be') ans = 'is';
                             else if(v.base.endsWith('o') || v.base.endsWith('ch') || v.base.endsWith('sh')) ans = v.base + 'es';
                             else ans = v.base + 's';
                         } else if(v.base === 'be') ans = (s === 'I' ? 'am' : 'are');
                         
                         q = { text: `${s} ${randTimeFreq()} ___ (${v.base}) ${randObj()}.`, answer: ans };
                    }
            ...
            // 3. PRESENT CONTINUOUS
                ...
                const verbs = getUniqueVerbs([...VERBS_REGULAR, ...VERBS_IRREGULAR].filter(v => v.base !== 'be' && v.base !== 'have' && v.base !== 'know' && v.base !== 'like'), count);
                verbs.forEach((v, i) => {
                    const s = randSubj();
                    let be = "are"; if(s==="I") be="am"; else if(["He","She","It","The student","My friend"].some(x=>s.includes(x))) be="is";
                    exercises.push({ text: `Look! ${s} ___ (${v.base}) ${randObj()}.`, answer: `${be} ${toIng(v.base)}`, id: `cont_${i}`, type: 'gap' });
                });
            }
            // 4. PERFECT
                ...
                verbs.forEach((v, i) => {
                    const s = randSubj();
                    const has = ["He","She","It","The student"].some(x=>s.includes(x)) ? "has" : "have";
                    exercises.push({ text: `${s} ___ (just / ${v.base}) ${randObj()}.`, answer: `${has} just ${v.pp}`, id: `perf_${i}`, type: 'gap' });
                });
            }
            // 5. FUTURE
                ...
                verbs.forEach((v, i) => {
                    const s = randSubj();
                    exercises.push({ text: `I think ${s} ___ (${v.base}) ${randObj()} ${randTimeFut()}.`, answer: `will ${v.base}`, id: `fut_${i}`, type: 'gap' });
                });
            }
            // 6. PASSIVE
            else if (t.includes("passive")) {
                 // Use verbs that make sense in passive (transitive)
                 const passiveVerbs = VERBS_IRREGULAR.filter(v => ["write","eat","drink","buy","sell","make","build","speak","teach","send"].includes(v.base));
                 const pVerbs = getUniqueVerbs(passiveVerbs, count);
                 pVerbs.forEach((v, i) => {
                     const obj = ["The letter", "The car", "The house", "The book", "The email", "Dinner"][i % 6];
                     exercises.push({ text: `${obj} ___ (${v.base}) by ${randSubj().toLowerCase()}.`, answer: `was ${v.pp}`, id: `pass_${i}`, type: 'gap' });
                 });
            }
            // 7. PREPOSITIONS
            else if (t.includes("preposition")) {
                const preps = [
                    {t: "He is interested ___ art.", a: "in"}, {t: "She is good ___ math.", a: "at"}, {t: "Wait ___ me!", a: "for"},
                    {t: "Listen ___ the teacher.", a: "to"}, {t: "Look ___ the picture.", a: "at"}, {t: "I agree ___ you.", a: "with"},
                    {t: "It depends ___ the weather.", a: "on"}, {t: "They arrived ___ London.", a: "in"}, {t: "She arrived ___ the airport.", a: "at"}
                ];
                for(let i=0; i<count; i++) {
                    const p = preps[i % preps.length];
                    exercises.push({ text: p.t, answer: p.a, id: `prep_${i}`, type: 'gap' });
                }
            }
            // FALLBACK FOR OTHERS (Conditionals, Advanced, etc.)
            else {
                const fallbackPool = [
                    {t: "If I go, I ___ (see) him.", a: "will see"}, {t: "If I went, I ___ (see) him.", a: "would see"},
                    {t: "I enjoy ___ (read).", a: "reading"}, {t: "She decided ___ (go).", a: "to go"},
                    {t: "The man ___ (who/which) called.", a: "who"}, {t: "The book ___ (who/which) I read.", a: "which"}
                ];
                for(let i=0; i<count; i++) {
                     const p = fallbackPool[i % fallbackPool.length];
                     exercises.push({ text: p.t, answer: p.a, id: `fall_${i}`, type: 'gap' });
                }
            }
           
            // Final shuffle of the exercises list
        ...
        function TestDetailView({ test, onBack, onRetry }) {
            return (
                <div className="animate-smooth-view">
                    <button onClick={onBack} className="flex items-center gap-2 text-slate-400 hover:text-slate-700 font-bold mb-6 transition-colors"><Icon name="arrow-left" size={18} /> Back to Stats</button>
                    <div className="glass-card p-8 rounded-[2.5rem] mb-6">
                        <div className="flex justify-between items-center mb-6 border-b border-slate-100 pb-4">
                            <div><h2 className="text-2xl font-black text-slate-800">{test.topic}</h2><p className="text-slate-400 text-sm">{test.date}</p></div>
                            <div className={`text-3xl font-black ${test.score === test.total ? 'text-emerald-500' : 'text-indigo-600'}`}>{test.score}/{test.total}</div>
                        </div>
                        <h3 className="font-bold text-slate-700 mb-4 flex items-center gap-2"><Icon name="alert-circle" size={20} className="text-red-500"/> Mistakes to Review</h3>
                            ...
                            {test.mistakes && test.mistakes.length > 0 ? (
                                test.mistakes.map((m, i) => (
                                    <div key={i} className="bg-red-50 p-4 rounded-xl border border-red-100">
                                        ...
                                        <div className="flex justify-between items-center text-sm"><span className="text-red-500">Your answer: <span className="line-through font-bold">{m.userAnswer || "—"}</span></span><span className="text-emerald-600 font-bold bg-emerald-50 px-2 py-1 rounded">Correct: {m.answer}</span></div>
                                    </div>
                                ))
                            ) : (
                                <div className="text-center py-8 text-emerald-600 font-bold bg-emerald-50 rounded-2xl"><Icon name="check-circle" className="mx-auto mb-2" size={32} /> Perfect Score! No mistakes to review.</div>
                            )}
                        </div>
                        {test.mistakes && test.mistakes.length > 0 && (
                ...
                <div className="min-h-screen font-sans text-slate-900 pb-12 overflow-x-hidden selection:bg-indigo-200">
                    ...
                    <nav className="sticky top-4 z-40 mx-4 max-w-5xl md:mx-auto">
                        <div className="glass-panel rounded-2xl px-6 py-4 flex justify-between items-center shadow-lg shadow-blue-900/5">
                            ...
                            <div className="flex gap-2 text-sm font-bold text-slate-500 overflow-x-auto">
                            ...
                            <div className="animate-card">
                                <div className="glass-card p-10 rounded-[2.5rem] mb-12 text-center relative overflow-hidden">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
                                        <button onClick={() => handleModeChange('theory')} className="p-8 bg-blue-50 rounded-[2rem] border border-blue-100 hover:shadow-xl hover:scale-105 transition-all group flex flex-col items-center justify-center gap-4">
                                            <Icon name="book-open" className="text-blue-600 group-hover:scale-110 transition-transform" size={48} />
                                            <h3 className="font-black text-slate-800 text-2xl">Theory</h3>
                                        </button>
                                        <button onClick={() => handleModeChange('practice')} className="p-8 bg-indigo-50 rounded-[2rem] border border-indigo-100 hover:shadow-xl hover:scale-105 transition-all group flex flex-col items-center justify-center gap-4">
                                            <Icon name="check-circle" className="text-indigo-600 group-hover:scale-110 transition-transform" size={48} />
                                            <h3 className="font-black text-slate-800 text-2xl">Practice Mode</h3>
                                        </button>
                                    </div>
                                </div>
                            </div>
                                ...
                                {qIndex === -1 ? (
                                    ...
                                    <PracticeView
                                        ...
                                        onAnswer={(isCorrect, answerData) => {
                                            ...
                                            else { const finalMistakes = !isCorrect ? [...currentMistakes, { ...exercises[qIndex], userAnswer: answerData }] : currentMistakes; saveResult(currentTopic, score + (isCorrect ? 1 : 0), exercises.length, finalMistakes); setTimeout(() => { setShowConfetti(true); setTimeout(() => setShowConfetti(false), 3000); setView('stats'); }, 500); }
                                        }}
                                    />
                                )}
                            </div>
